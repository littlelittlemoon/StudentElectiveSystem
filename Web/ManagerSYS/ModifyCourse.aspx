<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="ModifyCourse.aspx.cs" Inherits="Web.ModifyCourse" %>
            ...
            <div class="content_formdiv">
                <table class="content_table">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DDL_Credit" runat="server" Width="204px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DDL_Period" runat="server" Width="204px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DDL_CourseSp" runat="server" AutoPostBack="True" Width="204px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DDL_Species" runat="server" Width="204px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="DDL_CTeacher" runat="server" Width="204px">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center">
                            <asp:Button ID="btn_ModifyCourse" runat="server" Text="确认修改" CssClass="btn" OnClick="btn_ModifyCourse_Click" />
                        </td>
                    </tr>
                </table>
            </div>
